export default {
  ...
  tiles: {
    'L1a': {
      monsterTokens: {
        2: [
          { type: 'Bandit guard', counts: { elite: 1, normal: 2 } }
        ],
        3: [
          { type: 'Bandit guard', counts: { elite: 0, normal: 6 } }
        ],
        4: [
          { type: 'Bandit guard', counts: { elite: 2, normal: 4 } }
        ]
      }
    },
    'G1b': {
      monsterTokens: {
        2: [
          { type: 'Bandit archer', counts: { elite: 1, normal: 0 } },
          { type: 'Bandit guard', counts: { elite: 0, normal: 2 } }
        ],
        3: [
          { type: 'Bandit archer', counts: { elite: 1, normal: 2 } },
          { type: 'Bandit guard', counts: { elite: 1, normal: 0 } }
        ],
        4: [
          { type: 'Bandit archer', counts: { elite: 1, normal: 2 } },
          { type: 'Bandit guard', counts: { elite: 1, normal: 2 } }
